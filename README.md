...
# Elastic Export Schuhe.de Plugin for plentymarkets 7

This is the elastic export Schuhe.de plugin for plentymarkets 7 which extends the list of possible export formats.
